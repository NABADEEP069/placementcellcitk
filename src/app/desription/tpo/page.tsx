    ...
    <main style={{ padding: "5%", margin: "0 auto", maxWidth: "1200px" }}>
      ...
      <div style={{ margin: "2%" }}>
        <p style={{ textAlign: "justify", fontSize: "1rem", lineHeight: "1.6" }}>
          ...
          benefit both our students and your organization. CIT Kokrajhar is a center
          of skills, innovation, and human resource development, focusing especially
          on fulfilling the needs of vocational and technical education in the
          Bodoland Territorial Region. I am glad to inform you that the majority of
          students at this institute are from BTR and NE India, with a good number of
          students from other states of India too. CIT is mandated to impart technical
          and vocational education, such as Information Technology, Construction
          Technology, Food Processing Technology, Electronics and Communication
          Engineering, Instrumentation Engineering, Multimedia Communication and
          Design, etc.
        </p>
        <br />
        <p style={{ textAlign: "justify", fontSize: "1rem", lineHeight: "1.6" }}>
          ...
          young technical graduates and researchers. While we have IITs, NITs, IISc,
          and other institutes of national importance in the country, institutes like
          CIT Kokrajhar fulfill the aspirations and needs of many underprivileged
          students and students from remote places. Since assuming my additional charge
          as the Director of CIT Kokrajhar, I have come to know that many of our alumni
          are pursuing MTech and PhD in IISc/IITs and abroad, and that many are placed
          in various prestigious positions in the industry. These achievements are the
          pride of CIT Kokrajhar, and we can learn a lot from these accomplishments of
          the alumni.
        </p>
        <br />
        <p style={{ textAlign: "justify", fontSize: "1rem", lineHeight: "1.6" }}>
