...
export default function CardOne() {
  return (
    <div className="flex flex-col sm:flex-row sm:justify-center items-center relative">
      <div className="h-[16.5rem] w-[16.5rem] bg-gray-300 sm:absolute right-72 rounded-2xl overflow-hidden">
        <Image
      ...
      <div className="sm:h-[19rem] bg-white sm:w-1/2 sm:pr-48 p-5 sm:rounded-2xl flex flex-col justify-between shadow-lg">
        <div>
